...
struct FUIWidgetRow :public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSubclassOf<class UShooterUserWidget> MessageWidget;
...
class DEMO_API UOverlayWidgetController : public UShooterWidgetController
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "GASMessages")
